...
<nav class="uk-navbar-container uk-navbar-transparent" uk-navbar>
    <div class="uk-navbar-left">
        <ul class="uk-navbar-nav">
            <li>
                <a class="uk-button" type="button" uk-tooltip="title: Open Navigation Bar; pos: right" uk-toggle="target: #offcanvas-nav"><span uk-icon="icon: menu; ratio: 1.5;"></span><span class="uk-margin-left" style="color: white;">Discover the latest Post!</span></a>
            </li>
        </ul>
        ...
        <div>
            <div class="uk-margin uk-margin-small">
                <a href="{{ route('user.show',$img) }}">
                    <img src="/storage/images/{{ $img->image }}" alt="{{ $img->image }}" style="max-height:75%; border-radius: 2%;">
                </a>
            </div>
        </div>
        @endforeach
